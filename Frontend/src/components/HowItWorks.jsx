    ...
    <section className="how-it-works" id="how">
      ...
      <div className="steps-grid reveal visible">
        <div className="step-card">
          ...
          <div class="step-title">Scan Your Fridge</div>
        ...
        <div className="step-card">
          ...
          <div className="step-icon">🧠</div>
          <div class="step-title">AI Tracks Expiry</div>
        ...
        <div className="step-card">
          ...
          <div className="step-icon">👨‍🍳</div>
          <div class="step-title">Get Recipe Ideas</div>
        ...
        <div className="step-card">
          ...
          <div className="step-icon">📊</div>
          <div class="step-title">Track Your Impact</div>
